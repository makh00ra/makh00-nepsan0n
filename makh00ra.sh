...
# makh00ra Script for n3psan0n[Anonymous] Internet Navigation
# This scripts depends on tor gateway, U can surf anonymously but U
# can be tracked by big companies and experts according to tor policy
#
# This script is intended to set up your makh00ra machine to guarantee 
...
#
# Author: makh00ra <makh00ra.n3ps@gmail.com>
# Version: 1.0

# Inspired by Parrot OS Anonimity and Backbox anonimity
...
REAL_HOSTNAME="makh00ra"

# Include default options, if any
if [ -f /etc/default/makh00ra-n3psan0n ] ; then
	. /etc/default/makh00ra-n3psan0n
fi
...
warning() {
	...
	echo "\n[i] Please edit /etc/default/makh00ra-n3psan0n with your custom values."
}
...
# makh00ra implementation of Transparently Routing Traffic Through Tor
...
do_start() {
	...
	echo "\n[i] Starting n3psan0n[anonymous] mode\n"
...
do_stop() {
	...
	echo "\n[i] Stopping n3psan0n[anonymous] mode\n"
...
do_status() {
	...
	echo "\n[i] Showing n3psan0n[anonymous] status\n"
